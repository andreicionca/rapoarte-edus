...
const selectElement = document.querySelector("#student-grades");
...
selectElement.addEventListener("change", (event) => {
  ...
  document.querySelector("#studentName").textContent = selectedStudent;
  const tbodyElement = document.querySelector("#grades-table tbody");
  tbodyElement.innerHTML = "";

  const studentData = gradesData[selectedStudent];
  Object.keys(studentData).forEach((discipline) => {
    const trElement = document.createElement("tr");
    const tdDisciplineElement = document.createElement("td");
    tdDisciplineElement.textContent = discipline;
    trElement.appendChild(tdDisciplineElement);
    studentData[discipline].forEach((grade) => {
